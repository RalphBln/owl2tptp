 ...
 */
package xyz.aspectowl.tptp.reasoner.util;
...
public class UnsortedTPTPWriter implements FolWriter {
     ...
     */
    public UnsortedTPTPWriter(Writer writer) {
        super();
        this.writer = writer;
    }
